...
const customers: Customer[] = [
    new Customer("Abdullah", "Shah","Male", 35, 3166783676, accounts[0]),
    new Customer("Hareem", "Jaweid","Female", 40, 3336783676, accounts[1]),
    new Customer("Sara", "Raza","Female", 30, 3416783676, accounts[2])
